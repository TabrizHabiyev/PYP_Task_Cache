...
namespace PYP_Task_Cache.Controllers
{
    public class ProductsController : Controller
    {
        private readonly PYP_Task_CacheDbContext _context;
         private readonly IDistributedCache _distributedCache;

        public ProductsController(PYP_Task_CacheDbContext context, IDistributedCache distributedCache)
        {
            _context = context;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PYP_Task_CacheDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
